...
// ==================== RATE OTPLATE TAB ====================
// Installment payment tracking - avansne fakture, rate, kamatne stope
...
// ==================== FISKALIZACIJA TAB ====================
// Serbian fiscalization - kasica, fiscal receipts, EPC QR
...
interface FiscalInvoice {
  ...
  partner: { name: string; pib: string | null } | null
}
...
export { RateOtplateTab, FiskalizacijaTab }
