...
export const COL_LETTERS = Array.from({ length: 26 }, (_, i) =>
...
export const FORMULA_LIST = [
  ...
  {
    name: "COUNT",
    desc: "Broj ćelija sa brojevima",
    syntax: "=COUNT(A1:A10)",
    example: "=COUNT(A1:A10)",
  },
  {
    name: "COUNTA",
    desc: "Broj ne-praznih ćelija",
    syntax: "=COUNTA(A1:A10)",
    example: "=COUNTA(A1:A10)",
  },
  {
    name: "MAX",
    desc: "Maksimalna vrednost",
    syntax: "=MAX(A1:A10)",
    example: "=MAX(A1:A10)",
  },
  {
    name: "MIN",
    desc: "Minimalna vrednost",
    syntax: "=MIN(A1:A10)",
    example: "=MIN(A1:A10)",
  },
  {
    name: "IF",
    desc: "Uslovni israz",
    syntax: "=IF(uslov,da,ne)",
    example: '=IF(A1>10,"Visoko","Nisko")',
  },
  {
    name: "AND",
    desc: "Logičko I",
  ...
  {
    name: "CONCATENATE",
    desc: "Spajanje teksta",
    syntax: '=CONCATENATE(A1," ",B1)',
    example: '=CONCATENATE(A1," ",B1)',
  },
  {
    name: "LEFT",
    desc: "Levi deo teksta",
    syntax: "=LEFT(A1,n)",
    example: "=LEFT(A1,5)",
  },
  {
    name: "RIGHT",
    desc: "Desni deo teksta",
    syntax: "=RIGHT(A1,n)",
    example: "=RIGHT(A1,5)",
  },
  {
    name: "MID",
    desc: "Srednji deo teksta",
    syntax: "=MID(A1,start,n)",
    example: "=MID(A1,2,3)",
  },
  {
    name: "LEN",
  ...
  {
    name: "TRIM",
    desc: "Ukloni suvišne razmake",
    syntax: "=TRIM(A1)",
    example: "=TRIM(A1)",
  },
  {
    name: "ROUND",
    desc: "Zaokruži na decimale",
    syntax: "=ROUND(A1,2)",
    example: "=ROUND(A1,2)",
  },
  {
    name: "ABS",
    desc: "Apsolutna vrednost",
    syntax: "=ABS(A1)",
    example: "=ABS(A1)",
  },
  {
  ...
  {
    name: "SQRT",
    desc: "Kvadratni koren",
    syntax: "=SQRT(A1)",
    example: "=SQRT(A1)",
  },
  {
    name: "MOD",
    desc: "Ostatak deljenja",
    syntax: "=MOD(A1,2)",
    example: "=MOD(A1,2)",
  },
  {
  ...
  {
    name: "VLOOKUP",
    desc: "Vertikalna pretraga",
    syntax: "=VLOOKUP(val,range,col)",
    example: "=VLOOKUP(A1,B1:C10,2)",
  },
  {
    name: "COUNTIF",
    desc: "Broj po uslovu",
    syntax: "=COUNTIF(range,uslov)",
    example: '=COUNTIF(A1:A10,">5")',
  },
  {
    name: "SUMIF",
    desc: "Zbir po uslovu",
    syntax: "=SUMIF(range,uslov,suma)",
    example: '=SUMIF(A1:A10,">5")',
  },
  {
    name: "AVERAGEIF",
    desc: "Prosek po uslovu",
    syntax: "=AVERAGEIF(range,uslov)",
...
export const TEMPLATES: SpreadsheetTemplate[] = [
  {
    id: "blank",
    name: "Prazan dokument",
    description: "Prazan radni list sa 100 redova i 26 kolona",
    icon: "📄",
    category: "Opšte",
    sheetCount: 1,
  },
  {
    id: "budget",
    name: "Budžet",
    description: "Mesečni budžet sa prihodima, rashodima i stanjem",
    icon: "💰",
    category: "Finansije",
    sheetCount: 3,
  },
  {
    id: "inventory",
    name: "Inventar",
    description: "Popis robe sa količinama, cenama i vrednostima",
    icon: "📦",
    category: "Magacin",
    sheetCount: 2,
  },
  {
    id: "employees",
    name: "Spisak zaposlenih",
    description: "Podaci o zaposlenima sa platama i odeljenjima",
    icon: "👥",
    category: "HR",
    sheetCount: 2,
  },
  {
    id: "sales",
    name: "Praćenje prodaje",
    description: "Dnevna prodaja sa analizom po proizvodima",
    icon: "📈",
    category: "Prodaja",
    sheetCount: 3,
  },
  {
    id: "timesheet",
    name: "Evidencija vremena",
    description: "Nedeljna evidencija po zaposlenima i projektima",
    icon: "⏱️",
    category: "Projekti",
    sheetCount: 2,
  },
  {
    id: "crm_leads",
    name: "CRM Lead-ovi",
    description: "Spisak lead-ova sa statusom i praćenjem",
    icon: "🎯",
    category: "CRM",
    sheetCount: 2,
  },
  {
    id: "invoice_tracker",
    name: "Praćenje faktura",
    description: "Pregled faktura sa rokovima plaćanja",
    icon: "🧾",
    category: "Finansije",
    sheetCount: 2,
  },
  {
    id: "project_gantt",
    name: "Projektni plan",
    description: "Gantt dijagram sa zadacima i rokovima",
    icon: "📋",
    category: "Projekti",
    sheetCount: 2,
  },
  {
    id: "kpi_dashboard",
    name: "KPI Ploča",
    description: "Ključni pokazatelji performansi",
    icon: "📊",
    category: "Analitika",
    sheetCount: 2,
  },
...
export const condition = expr
  .slice(expr.lastIndexOf(",") + 1, -1)
  .trim()
  .replace(/^["']|["']$/g, "");
...
export const filtered = range.filter(
  (v) =>
    String(v) === condition ||
    (typeof v === "number" && this.evaluateCondition(`${v}${condition}`)),
);
...
export const args = this.splitFormulaArgs(
  expr.slice(upper.startsWith("CONCATENATE") ? 12 : 7, -1),
);
...
export const searchVal =
  ...
  String(this.getCellValue(parts[0].trim()));
...
export const firstColVal = String(
  this.getCellValue(getCellRef(r, Math.min(startParsed.col, endParsed.col))),
);
