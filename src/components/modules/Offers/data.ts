...
export const STATUS_CONFIG: Record<string, { labelKey: string; color: string }> = {
  draft: { labelKey: 'offers.statusDraft', color: 'bg-slate-100 text-slate-700 border-slate-200' },
  sent: { labelKey: 'offers.statusSent', color: 'bg-amber-50 text-amber-700 border-amber-200' },
  confirmed: { labelKey: 'offers.statusAccepted', color: 'bg-emerald-50 text-emerald-700 border-emerald-200' },
  rejected: { labelKey: 'offers.statusRejected', color: 'bg-red-50 text-red-700 border-red-200' },
  cancelled: { labelKey: 'offers.statusCancelled', color: 'bg-red-50 text-red-700 border-red-200' },
};
