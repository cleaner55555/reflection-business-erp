...
export const mockEmployees: {
  ...
  },
  {
    ...
    name: "Ivan Đorđević",
    department: "HR",
    position: "HR Specijalista",
  },
  {
    id: "emp-6",
    name: "Marija Todorović",
    department: "Prodaja",
    position: "Prodajni direktor",
  },
  {
    id: "emp-7",
  ...
  {
    id: "emp-8",
    name: "Snežana Milovanović",
    department: "Finansije",
    position: "Računovodja",
  },
  {
    id: "emp-9",
    name: "Aleksandar Popović",
    department: "Razvoj",
    position: "QA Inženjer",
  },
  {
    id: "emp-10",
    name: "Dragana Mladenović",
    department: "Marketing",
...
export const mockCriteria: {
...
}[] = [
  {
    id: "cr-1",
    name: "Stručnost",
    category: "kompetencije",
    description: "Nivo stručnog znanja i veština",
    weight: 25,
    scaleMax: 5,
    active: true,
  },
  {
    ...
    name: "Timski rad",
    category: "kompetencije",
    description: "Saradnja i komunikacija u timu",
    weight: 20,
    scaleMax: 5,
    active: true,
  },
  {
    ...
    name: "Produktivnost",
    category: "kpi",
    description: "Količina i kvalitet obavljenog posla",
    weight: 20,
    scaleMax: 5,
    active: true,
  },
  {
    ...
    name: "Inicijativa",
    category: "kompetencije",
    description: "Proaktivnost i predlaganje rešenja",
    weight: 15,
    scaleMax: 5,
    active: true,
  },
  {
    ...
    name: "Ciljevi",
    category: "ciljevi",
    description: "Postizanje postavljenih ciljeva",
    weight: 15,
    scaleMax: 5,
    active: true,
  },
  {
    ...
    name: "Vodstvo",
    category: "kompetencije",
    description: "Vođenje i motivisanje tima",
    weight: 5,
    scaleMax: 5,
    active: false,
  },
...
export function calcOverall(
  ...
  criteria: { id: string; weight: number; active: boolean }[],
): number {
