...
> = {
  inbound: {
    labelKey: "voip.direction.inbound",
    color:
      "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400",
  },
  outbound: {
    labelKey: "voip.direction.outbound",
    color: "bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-400",
  },
  internal: {
    labelKey: "voip.direction.internal",
    color:
...
> = {
  answered: {
    labelKey: "voip.status.answered",
    color:
      "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400",
  },
  missed: {
    labelKey: "voip.status.missed",
    color: "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400",
  },
  voicemail: {
    labelKey: "voip.status.voicemail",
    color:
      "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400",
  },
};

export const extStatusConfig: Record<
  string,
...
export const MOCK_EXTENSIONS: Extension[] = [
  ...
  },
  {
    id: "e8",
    number: "108",
    name: "Dejan Tanasković",
    department: "Menadžment",
    type: "Desk",
    status: "Offline",
    device: "Polycom VVX 601",
    ipAddress: "-",
...
export const MOCK_IVR_MENUS: IvrMenu[] = [
  ...
  {
    id: "ivr3",
    name: "Nakradno pozdrav",
    phoneNumber: "+381112345680",
    language: "en",
    active: false,
    entries: [
      {
...
export const MOCK_SIP_TRUNKS: SipTrunk[] = [
  {
    id: "sip1",
    provider: "Orion Telekom",
    username: "reflection-main",
    host: "sip.orion.rs",
    port: "5060",
    status: "connected",
  },
...
export const MOCK_DIAL_PLANS: DialPlan[] = [
  ...
  },
  {
    id: "d2",
    prefix: "00",
    description: "Međunarodni pozivi",
    stripDigits: 2,
    active: true,
  },
  {
