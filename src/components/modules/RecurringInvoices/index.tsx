    ...
    <div className="space-y-6">
      ...
      <Tabs value={subTab} onValueChange={(v) => setSubTab(v as 'pregled' | 'dodaj')}>
        <TabsList>
          ...
          <TabsTrigger value="dodaj">{editing ? 'Uredi' : 'Dodaj'}</TabsTrigger>
        </TabsList>
          ...
          <Card className="max-w-2xl">
            <CardHeader>
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="icon" className="h-7 w-7" onClick={() => { setSubTab('pregled'); resetForm() }}><ArrowLeft className="h-4 w-4" /></Button>
            ...
            <CardContent className="space-y-4 max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <Button variant="outline" onClick={() => { setSubTab('pregled'); resetForm() }}>
                  {t('common.cancel')}
                </Button>
              </div>
            </CardContent>
