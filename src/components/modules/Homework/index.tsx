...
import { Plus, Search, Trash2, Pencil, Eye, BookOpen, CheckCircle2, Clock, AlertCircle, ArrowLeft } from 'lucide-react'
...
<CardHeader className="flex flex-row items-center gap-2">
              <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" onClick={() => setDetailId(false)}>
                <ArrowLeft className="h-4 w-4" />
              </Button>
              <div className="min-w-0 flex-1"><CardTitle className="text-base">Detalji obaveze</CardTitle></div>
            </CardHeader>
          {detailItem && (
