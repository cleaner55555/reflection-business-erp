...
export const emp =
  MOCK_EMPLOYEES[Math.floor(Math.random() * MOCK_EMPLOYEES.length)];
...
export const items: GanttItem[] = [
  {
    id: "g1",
    projectName: "Web Portal v2.0",
    employeeName: "Marko Petrović",
    startDate: offsetDate(today, -5),
    endDate: offsetDate(today, 10),
    progress: 65,
    color: "#6366f1",
  },
  {
    ...
    startDate: offsetDate(today, -3),
    endDate: offsetDate(today, 12),
    progress: 40,
    color: "#6366f1",
  },
  {
    id: "g3",
    projectName: "Mobilna Aplikacija",
    employeeName: "Nikola Stanković",
  ...
  },
  {
    id: "g4",
    projectName: "Mobilna Aplikacija",
    employeeName: "Jelena Nikolić",
    startDate: offsetDate(today, -2),
    endDate: offsetDate(today, 15),
    progress: 25,
    color: "#f59e0b",
  },
  {
    id: "g5",
    projectName: "ERP Integracija",
    employeeName: "Stefan Ilić",
    startDate: offsetDate(today, -10),
  ...
  },
  {
    ...
    employeeName: "Marko Petrović",
    startDate: offsetDate(today, 5),
    endDate: offsetDate(today, 20),
    progress: 0,
    color: "#10b981",
  },
  {
    id: "g7",
    projectName: "Infrastruktura",
    employeeName: "Nikola Stanković",
    startDate: offsetDate(today, 0),
    endDate: offsetDate(today, 7),
    progress: 50,
    color: "#ef4444",
  },
  {
...
export const empSlots = slots.filter(
  (s) => s.employeeId === emp.id && s.status !== "cancelled",
);
