export const STATUS_CONFIG: Record<
  string,
  { label: string; color: string; nextStatus?: string }
> = {
  scheduled: {
    label: "Zakazano",
...
export const MOCK_CLIENTS: Client[] = [
  {
    ...
    isVip: true,
    notes: "Redovan klijent",
    preferences: "Preferira jutarnje termine",
  },
  {
    id: "c2",
    name: "Ana Marković",
  ...
  },
  {
    ...
    isVip: true,
    notes: "VIP klijent od 2023",
    preferences: "Samo četvrtkom",
  },
  {
    id: "c4",
    name: "Jelena Nikolić",
  ...
  },
  {
    ...
    isVip: false,
    notes: "Alergija na neke supstance",
    preferences: "Popodnevni termini",
  },
];
...
export const MOCK_SERVICES: Service[] = [
  {
    id: "s1",
    name: "Opšta konsultacija",
    description: "Inicijalni pregled i procena",
    duration: 30,
    price: 3000,
  ...
  },
  {
    ...
    description: "Kontrola nakon tretmana",
    duration: 15,
    price: 1500,
    category: "konsultacija",
    bookingCount: 32,
  ...
  {
    id: "s3",
    name: "Dubinski tretman",
    description: "Intenzivan tretman lica",
    duration: 60,
    price: 5000,
    category: "tretman",
    bookingCount: 28,
  },
  {
    id: "s4",
    name: "Hidratacija",
    description: "Tretman hidratacije kože",
    duration: 45,
    price: 4000,
    category: "tretman",
    bookingCount: 38,
  },
  {
    id: "s5",
    name: "Analiza kože",
    description: "Detaljna analiza tipa kože",
    duration: 30,
    price: 2500,
    category: "analiza",
    bookingCount: 22,
  },
  {
    id: "s6",
    name: "Piling",
    description: "Hemijski piling lica",
    duration: 45,
    price: 3500,
    category: "procedure",
    bookingCount: 19,
  ...
  {
    id: "s7",
    name: "Individualna edukacija",
    description: "Jedan na jedan sesija",
    duration: 60,
    price: 6000,
    category: "drustveno",
    bookingCount: 8,
...
export const MOCK_STAFF: StaffMember[] = [
  {
    id: "st1",
    name: "Dr. Marina Kovačević",
    specialties: "Konsultacije, Tretmani",
  ...
  },
  {
    ...
    specialties: "Online konsultacije",
