...
export const BILLING_STATUS_COLORS: Record<BillingStatus, string> = {
  ...
  invoiced: 'bg-violet-100 text-violet-800 dark:bg-violet-900 dark:text-violet-300',
...
export type TimeEntryFormData = Omit<TimeEntry, 'id' | 'billingStatus' | 'invoiceId' | 'createdAt' | 'updatedAt'>
export type InvoiceFormData = Omit<Invoice, 'id' | 'invoiceNumber' | 'subtotal' | 'pdvAmount' | 'total' | 'status' | 'createdAt' | 'updatedAt'>
