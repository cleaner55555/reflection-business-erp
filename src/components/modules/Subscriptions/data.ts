  ...
  return [
    {
      id: "plan-1",
      name: "Starter",
      description: "Osnovni paket za male timove",
      price: 2900,
    ...
    },
    {
      id: "plan-2",
      name: "Professional",
      description: "Napredni paket za rastuće kompanije",
      price: 7900,
      billingCycle: "monthly",
      features: [
        "25 korisnika",
    ...
    },
    {
      id: "plan-3",
      name: "Enterprise",
      description: "Kompletno rešenje za velike organizacije",
      price: 19900,
      billingCycle: "monthly",
      features: [
    ...
    },
    {
      id: "plan-4",
      name: "Business",
      description: "Paket za srednje firme",
      price: 12900,
    ...
    },
    {
      id: "plan-5",
      name: "Legacy",
      description: "Stari paket - više nije dostupan",
      price: 1900,
      billingCycle: "monthly",
      features: ["3 korisnika", "5 GB skladište", "Email podrška"],
      subscriberCount: 1,
      isActive: false,
      trialPeriod: 0,
      setupFee: 0,
...
export function generateMockSubscriptions() {
  return [
    {
      id: "sub-1",
      customer: "Jovan Petrović - JP Doo",
      planId: "plan-3",
      planName: "Enterprise",
    ...
    {
      id: "sub-2",
      customer: "Ana Marković - AM Solutions",
      planId: "plan-2",
    ...
    {
      id: "sub-3",
      customer: "Nikola Stanković - NS Tech",
      planId: "plan-1",
      planName: "Starter",
    ...
    {
      id: "sub-4",
      customer: "Milena Jovanović - MJ Consulting",
      planId: "plan-2",
      planName: "Professional",
    ...
    {
      id: "sub-6",
      customer: "Jelena Đorđević - JD Studio",
      planId: "plan-1",
      planName: "Starter",
    ...
    {
      id: "sub-8",
      customer: "Ivana Vasić - IV Marketing",
      planId: "plan-2",
      planName: "Professional",
    ...
    {
      id: "sub-9",
      customer: "Darko Todorović - DT Systems",
      planId: "plan-5",
      planName: "Legacy",
    ...
    {
      id: "sub-10",
      customer: "Sanja Milosavljević - SM Design",
      planId: "plan-1",
      planName: "Starter",
    ...
    {
      id: "sub-11",
      customer: "Branislav Kostić - BK Finance",
      planId: "plan-4",
      planName: "Business",
    ...
    {
      id: "sub-12",
      customer: "Dragana Radovanović - DR Legal",
      planId: "plan-2",
      planName: "Professional",
