...
export const INITIAL: LabEquipment[] = [
  {
    id: "1",
    inventoryNo: "INV-LAB-001",
    name: "Mikrometar digitalni",
    category: "measurement",
    manufacturer: "Mitutoyo",
    model: "293-340-30",
    serialNo: "MT-2022-4456",
    location: "B-105 Kabinet 3",
    status: "operational",
    ...
    condition: "excellent",
    notes: "Kalibracija svakih 6 meseci",
  },
  {
    id: "2",
    inventoryNo: "INV-LAB-002",
    name: "Osciloskop digitalni 4-kanalni",
    category: "electrical",
    manufacturer: "Keysight",
    model: "DSOX1104G",
    serialNo: "KS-2023-7821",
    location: "B-105 Radni sto 1",
    status: "operational",
    ...
    condition: "excellent",
    notes: "100MHz, 4 kanala",
  },
  {
    id: "3",
    inventoryNo: "INV-LAB-003",
    name: "Spektrofotometar UV-Vis",
    category: "optical",
    manufacturer: "Shimadzu",
    model: "UV-1800",
    serialNo: "SH-2021-3312",
    location: "B-106 Stol 2",
    status: "calibration",
    ...
    condition: "good",
    notes: "Na kalibraciji — povratak 20.06.",
  },
  {
    id: "4",
    inventoryNo: "INV-LAB-004",
    name: "pH metar digitalni",
    category: "chemical",
    manufacturer: "Hanna Instruments",
    model: "HI-5222",
    serialNo: "HI-2022-5567",
    location: "B-106 Stol 1",
    status: "operational",
    ...
    responsible: "Prof. Goran Savić",
    condition: "good",
    notes: "Mesečna kalibracija elektrode",
  },
  {
    id: "5",
    inventoryNo: "INV-LAB-005",
    name: "Univerzalna mašina za ispitivanje",
    category: "mechanical",
    manufacturer: "Instron",
    model: "3369",
    serialNo: "IN-2020-8890",
    location: "D-301 Zona A",
    status: "maintenance",
    ...
    condition: "fair",
    notes: "Zamena hidrauličnog ulja — servis u toku",
  },
  {
    id: "6",
    inventoryNo: "INV-LAB-006",
    name: "Mikroskop binokularni",
    category: "optical",
    manufacturer: "Zeiss",
    model: "Stemi 508",
    serialNo: "ZS-2021-2234",
    location: "B-106 Stol 3",
    status: "operational",
    ...
    responsible: "Prof. Snežana Đorđević",
    condition: "excellent",
    notes: "Povećanje 7x-40x",
  },
  {
    id: "7",
    inventoryNo: "INV-LAB-007",
    name: "Multimer digitalni",
    category: "electrical",
    manufacturer: "Fluke",
    model: "87V",
    serialNo: "FK-2023-1145",
    location: "B-105 Ormar 2",
    status: "operational",
    purchaseDate: "2023-04-10",
    purchasePrice: 35000,
    lastCalibration: "2024-06-05",
    nextCalibration: "2024-12-05",
    responsible: "Nenad Stojanović",
    condition: "excellent",
    notes: "",
  },
  {
    id: "8",
    inventoryNo: "INV-LAB-008",
    name: "Centrifuga laboratorijska",
    category: "mechanical",
    manufacturer: "Eppendorf",
    model: "5430R",
    serialNo: "EP-2022-6678",
    location: "B-106 Pult",
    status: "out_of_order",
    ...
    responsible: "Prof. Goran Savić",
    condition: "poor",
    notes: "Kvar na motoru — čeka se rezervni deo",
  },
  {
    id: "9",
    inventoryNo: "INV-LAB-009",
    name: "Termometar infracrveni",
    category: "digital",
    manufacturer: "Fluke",
    model: "62 MAX",
    serialNo: "FK-2023-9012",
    location: "B-105 Ormar 1",
    status: "operational",
  ...
  {
    id: "10",
    inventoryNo: "INV-LAB-010",
    name: "Analitička vaga",
    category: "measurement",
    manufacturer: "Mettler Toledo",
    model: "XS205",
    serialNo: "MT-2020-3456",
    location: "B-106 Stol 4",
    status: "stored",
    ...
    responsible: "Prof. Goran Savić",
    condition: "good",
    notes: "U skladištu do septembra — obnova laboratorije",
  },
];
