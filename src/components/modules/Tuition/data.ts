...
export const INITIAL: Tuition[] = [
  ...
  },
  {
    ...
    paidDate: "2024-03-28",
    paymentMethod: "bank_transfer",
    receiptNo: "RAC-2024-0512",
    installments: 2,
    currentInstallment: 1,
    discount: 0,
    notes: "Druga rata do 01.07.",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    receiptNo: "RAC-2024-0398",
    installments: 1,
    currentInstallment: 1,
    discount: 100,
    notes: "Republička stipendija za studente genijalce",
  },
  {
    id: "5",
    student: "Nikola Milić",
    indexNo: "2022/031",
    program: "Informatika",
    year: 3,
    semester: 5,
    ...
    currentInstallment: 0,
    discount: 0,
    notes: "Podsetnik poslat 20.05. — kontaktirana studentska služba",
  },
  {
    id: "6",
    student: "Sara Đorđević",
    indexNo: "2024/002",
    program: "Arhitektura",
    year: 1,
    semester: 1,
    ...
    paidDate: "2024-09-01",
    paymentMethod: "bank_transfer",
    receiptNo: "RAC-2024-0890",
    installments: 1,
    currentInstallment: 1,
    discount: 10,
    notes: "10% popust za rano upisivanje",
  },
  {
    id: "7",
    student: "Ivan Savić",
    ...
    currentInstallment: 0,
    discount: 100,
    notes: "Ostvario pravo na besplatne studije — prosečna ocena 9.85",
  },
  {
    id: "8",
    student: "Maja Stojanović",
    indexNo: "2023/056",
    program: "Psihologija",
    year: 2,
    semester: 3,
    ...
    paidDate: "2024-05-01",
    paymentMethod: "card",
    receiptNo: "RAC-2024-0634",
    installments: 3,
    currentInstallment: 1,
    discount: 0,
    notes: "Rata 2/3 do 01.08., rata 3/3 do 01.11.",
  },
  {
    id: "9",
    student: "Stefan Ilić",
