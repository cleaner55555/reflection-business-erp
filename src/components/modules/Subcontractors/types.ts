...
/** Contract status */
export type ContractStatus = 'aktivan' | 'istekao' | 'prekinut' | 'na_čekanju' | 'u_pripremi'

/** Delivery status */
export type DeliveryStatus = 'zatražena' | 'u_toku' | 'isporučena' | 'prihvaćena' | 'odbijena'
...
export type SubcontractorFormData = Omit<Subcontractor, 'id' | 'datumUnosa' | 'datumIzmene'>
...
export type ContractFormData = Omit<Contract, 'id' | 'datumUnosa' | 'datumIzmene'>
...
export type DeliveryFormData = Omit<Delivery, 'id' | 'datumUnosa' | 'datumIzmene'>
...
export type PaymentFormData = Omit<Payment, 'id' | 'datumUnosa' | 'datumIzmene'>
