...
export const initialSubcontractors: Subcontractor[] = [
  {
    ...
    pdvObveznik: true,
    adresa: { ulica: 'Bulevar Mihajla Pupina', broj: '10a', grad: 'Beograd', poštanskiBroj: '11070', opština: 'Palilula' },
    kontakti: [
      { ime: 'Milan', prezime: 'Jovanović', funkcija: 'Direktor', telefon: '+381 11 234 5678', email: 'milan.jovanovic@graditelj.rs' },
      { ime: 'Jelena', prezime: 'Petrović', funkcija: 'Finansijski savetnik', telefon: '+381 11 234 5679', email: 'jelena.petrovic@graditelj.rs' },
    ],
    bankovniRačuni: [
      { nazivBanke: 'Intesa Sanpaolo', račun: '265-1234567890123-45', pozivNaBroj: '97-1234567' },
    ],
    status: 'aktivan',
    ocena: 4,
  ...
  },
  {
    ...
    pdvObveznik: true,
    adresa: { ulica: 'Vojvode Mišića', broj: '25', grad: 'Niš', poštanskiBroj: '18000' },
    kontakti: [
      { ime: 'Nikola', prezime: 'Stanković', funkcija: 'Tehničar', telefon: '+381 18 345 678', email: 'nikola@instalaterplus.rs' },
    ],
    bankovniRačuni: [
      { nazivBanke: 'Eurobank', račun: '265-9876543210987-65', pozivNaBroj: '97-7654321' },
    ],
    status: 'aktivan',
    ocena: 5,
  ...
  },
  {
    ...
    pdvObveznik: true,
    adresa: { ulica: 'Bulevar oslobođenja', broj: '88', grad: 'Novi Sad', poštanskiBroj: '21000' },
    kontakti: [
      { ime: 'Dragan', prezime: 'Milić', funkcija: 'Inženjer', telefon: '+381 21 456 789', email: 'dragan.milic@elektromreza.rs' },
    ],
    bankovniRačuni: [
      { nazivBanke: 'OTP Banka', račun: '265-1111222233334-55', pozivNaBroj: '97-1122334' },
    ],
    status: 'aktivan',
    ocena: 3,
  ...
  },
  {
    ...
    pdvObveznik: false,
    adresa: { ulica: 'Trg Slobode', broj: '7', grad: 'Subotica', poštanskiBroj: '24000' },
    kontakti: [
      { ime: 'Siniša', prezime: 'Todorović', funkcija: 'Vlasnik', telefon: '+381 24 567 890', email: 'siniša@fasadtrade.rs' },
    ],
    bankovniRačuni: [
      { nazivBanke: 'Komercijalna Banka', račun: '265-4444555566667-88', pozivNaBroj: '97-4455667' },
    ],
    status: 'neaktivan',
    ocena: 2,
  ...
  },
  {
    ...
    pdvObveznik: true,
    adresa: { ulica: 'Đure Jakšića', broj: '3', grad: 'Kragujevac', poštanskiBroj: '34000' },
    kontakti: [
      { ime: 'Milorad', prezime: 'Lazić', funkcija: 'Šef radova', telefon: '+381 34 678 901', email: 'milorad@krovoprovac.rs' },
    ],
    bankovniRačuni: [
      { nazivBanke: 'AIK Banka', račun: '265-7777888899990-11', pozivNaBroj: '97-7788990' },
    ],
    status: 'aktivan',
    ocena: 4,
  ...
  },
  {
    ...
    pdvObveznik: true,
    adresa: { ulica: 'Žička', broj: '12', grad: 'Čačak', poštanskiBroj: '32000' },
    kontakti: [
      { ime: 'Goran', prezime: 'Radosavljević', funkcija: 'Direktor', telefon: '+381 32 789 012', email: 'goran@betonmix.rs' },
    ],
    bankovniRačuni: [
      { nazivBanke: 'UniCredit Bank', račun: '265-2222333344445-66', pozivNaBroj: '97-2233445' },
    ],
    status: 'suspendovan',
    ocena: 1,
...
export const initialContracts: Contract[] = [
  {
    ...
    opsegRadova: 'Izrada temelja, armiranobetonska konstrukcija parkinga, asfaltiranje, hidroizolacija',
    vrednost: 12500000,
  ...
  },
  {
    ...
    opsegRadova: 'Kompletna vodovodna mreža, sanitarna oprema, kanalizacija za 5 stambenih zgrada',
    vrednost: 8750000,
  ...
  },
  {
    ...
    opsegRadova: 'Uklanjanje starog pokrivača, postavljanje novog metalnog krova, limarija, provodnja',
    vrednost: 3100000,
  ...
  },
  {
    ...
    opsegRadova: 'Rušenje, novi zidovi, podovi, gips karton, bojenje, keramičke pločice',
    vrednost: 4800000,
...
export const initialDeliveries: Delivery[] = [
  {
    ...
    stavke: [
      { redniBroj: 1, opis: 'Beton B30 za temelje', količina: 50, jedinicaMere: 'm³', jediničnaCena: 9500, ukupno: 475000 },
      { redniBroj: 2, opis: 'Armatura Ø12', količina: 2000, jedinicaMere: 'kg', jediničnaCena: 120, ukupno: 240000 },
    ],
    ukupanIznos: 715000,
    status: 'prihvaćena',
  ...
  },
  {
    ...
    mestoIsporuke: 'Beograd — građevinska zona A',
    stavke: [
      { redniBroj: 1, opis: 'Asfalt AB 11 za parking', količina: 80, jedinicaMere: 't', jediničnaCena: 15000, ukupno: 1200000 },
    ],
    ukupanIznos: 1200000,
    status: 'u_toku',
  ...
  },
  {
    ...
    stavke: [
      { redniBroj: 1, opis: 'HDPE cevi Ø110', količina: 500, jedinicaMere: 'm', jediničnaCena: 800, ukupno: 400000 },
      { redniBroj: 2, opis: 'PVC cevi Ø50', količina: 300, jedinicaMere: 'm', jediničnaCena: 350, ukupno: 105000 },
      { redniBroj: 3, opis: 'Fitingi (razno)', količina: 1, jedinicaMere: 'kom', jediničnaCena: 45000, ukupno: 45000 },
    ],
    ukupanIznos: 550000,
    status: 'prihvaćena',
  ...
  },
  {
    ...
    stavke: [
      { redniBroj: 1, opis: 'Kablovi YKY 4x25', količina: 2000, jedinicaMere: 'm', jediničnaCena: 450, ukupno: 900000 },
      { redniBroj: 2, opis: 'Razvodne kutije', količina: 80, jedinicaMere: 'kom', jediničnaCena: 1200, ukupno: 96000 },
    ],
    ukupanIznos: 996000,
    status: 'prihvaćena',
    napomene: '',
  ...
  },
  {
    ...
    mestoIsporuke: 'Novi Sad — poslovni centar',
    stavke: [
      { redniBroj: 1, opis: 'UPS APC Smart-UPS 3000VA', količina: 4, jedinicaMere: 'kom', jediničnaCena: 180000, ukupno: 720000 },
    ],
    ukupanIznos: 720000,
    status: 'zatražena',
...
export const subcontractorStatusColors: Record<string, string> = {
  aktivan: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-300',
...
export const contractStatusColors: Record<string, string> = {
  ...
  na_čekanju: 'bg-amber-100 text-amber-800 dark:bg-amber-900 dark:text-amber-300',
...
export const deliveryStatusColors: Record<string, string> = {
  ...
  prihvaćena: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-300',
...
export const paymentStatusColors: Record<string, string> = {
  plaćeno: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-300',
  delačno: 'bg-amber-100 text-amber-800 dark:bg-amber-900 dark:text-amber-300',
  neplaćeno: 'bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-300',
...
export function calculateSpendingBySubcontractor(
  ...
  return subcontractors.map((sub) => {
    ...
    const ukupnoIsporučeno = subDeliveries.reduce((sum, d) => sum + d.ukupanIznos, 0)
    const ukupnoPlaćeno = subPayments.reduce((sum, p) => sum + p.iznosPlaćen, 0)
...
export const emptyDeliveryForm = {
  ...
  datumPrijema: '',
  mestoIsporuke: '',
  stavke: [{ redniBroj: 1, opis: '', količina: 0, jedinicaMere: 'kom', jediničnaCena: 0, ukupno: 0 }],
  ukupanIznos: 0,
