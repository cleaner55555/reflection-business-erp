...
export function emptyForm() {
  return { title: '', slug: '', typeId: 'ct-1', categoryId: '', authorId: '', status: 'draft', content: '', excerpt: '', featuredImage: '', tags: [] as string[], seoTitle: '', seoDescription: '', ogImage: '', scheduledAt: '', locale: 'sr' }
}
