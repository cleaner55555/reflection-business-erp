...
import type { BlogPost, BlogCategory, BlogComment, BlogTag } from './types'
...
export function PregledTab({ posts, categories, comments, tags }: { posts: BlogPost[]; categories: BlogCategory[]; comments: BlogComment[]; tags: BlogTag[] }) {
...
export function ClanciTab({ posts, setPosts, categories, tags }: {
...
export function KategorijeTab({ categories, setCategories, posts }: {
...
export function KomentariTab({ comments, setComments, posts }: {
...
export function TagoviTab({ tags, setTags, posts }: {
...
export function SeoAnalitikaTab({ posts, categories }: { posts: BlogPost[]; categories: BlogCategory[] }) {
  const { t } = useTranslation()
