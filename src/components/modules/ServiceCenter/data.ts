...
export const res = await fetch(`/api/service-orders?companyId=${activeCompanyId}&limit=100`);
...
export const handleStatusAdvance = async (order: ServiceOrder) => {
...
export const sCfg = STATUS_CONFIG[o.status]; const cCfg = CATEGORY_CONFIG[o.category]
