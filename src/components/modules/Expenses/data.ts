...
export function generateMockExpenses() {
  return [
    {
      id: "exp-1",
      description: "Kancelarijski materijal - papir, toneri",
      category: "office",
      amount: 18500,
      date: "2025-01-15",
      employee: "Marko Petrovic",
      employeeId: "emp-1",
      paymentMethod: "card",
      status: "approved",
      hasReceipt: true,
      notes: "Mesečna nabavka",
      createdAt: "2025-01-15T08:00:00Z",
    },
    {
      id: "exp-2",
      description: "Putovanje Novi Sad - sastanak klijent",
      category: "travel",
      amount: 12400,
      date: "2025-01-18",
      employee: "Jelena Nikolic",
      employeeId: "emp-2",
      paymentMethod: "company_account",
      status: "submitted",
      hasReceipt: true,
      notes: "Voz karta + taksii",
      createdAt: "2025-01-18T09:30:00Z",
    },
    {
      id: "exp-3",
      description: "Marketing kampanja - Google Ads",
      category: "marketing",
      amount: 85000,
      date: "2025-01-10",
      employee: "Ana Popovic",
      employeeId: "emp-4",
    ...
    {
      id: "exp-4",
      description: "Laptop za novog zaposlenog",
      category: "equipment",
      amount: 125000,
      date: "2025-01-20",
      employee: "Stefan Jovanovic",
      employeeId: "emp-3",
      paymentMethod: "bank_transfer",
      status: "paid",
      hasReceipt: true,
    ...
    {
      id: "exp-6",
      description: "Timski ručak - projekat Alpha",
      category: "other",
      amount: 15600,
      date: "2025-01-22",
      employee: "Jelena Nikolic",
    ...
    {
      id: "exp-7",
      description: "Printanje flajera 5000 kom",
      category: "marketing",
      amount: 42000,
      date: "2025-01-12",
      employee: "Ana Popovic",
    ...
    {
      id: "exp-8",
      description: "Pretplate softver - Adobe, Slack",
      category: "software",
      amount: 35600,
      date: "2025-01-05",
      employee: "Stefan Jovanovic",
    ...
    {
      id: "exp-9",
      description: "Kancelarijski sto za recepciju",
      category: "equipment",
      amount: 67800,
      date: "2025-01-28",
      employee: "Marko Petrovic",
    ...
    {
      id: "exp-10",
      description: "Internet provajder - januar",
      category: "utilities",
      amount: 9500,
      date: "2025-01-03",
      employee: "Nikola Milovanovic",
      employeeId: "emp-5",
      paymentMethod: "bank_transfer",
      status: "paid",
      hasReceipt: true,
    ...
    {
      id: "exp-11",
      description: "Putovanje Beograd-Nis - sajam",
      category: "travel",
      amount: 28900,
      date: "2025-01-14",
      employee: "Nikola Milovanovic",
      ...
      status: "rejected",
      hasReceipt: true,
      notes: "Nije prethodno odobreno",
      createdAt: "2025-01-14T07:00:00Z",
    },
    {
      id: "exp-12",
      description: "Stolice za konferencijsku salu x8",
      category: "office",
      amount: 48000,
      date: "2025-01-08",
      employee: "Ana Popovic",
  ...
  return [
    {
      ...
      totalAmount: 41300,
      expenseCount: 3,
      notes: "Sastanci sa klijentima",
      createdAt: "2025-01-25T10:00:00Z",
    },
    {
      id: "rep-2",
      title: "Marketing - Q1 2025",
      employee: "Ana Popovic",
      employeeId: "emp-4",
      dateFrom: "2025-01-01",
      dateTo: "2025-03-31",
      ...
      totalAmount: 127000,
      expenseCount: 2,
      notes: "Online i print kampanje",
      createdAt: "2025-01-20T09:00:00Z",
    },
    {
      id: "rep-3",
      title: "IT oprema - januar",
      employee: "Stefan Jovanovic",
      employeeId: "emp-3",
      dateFrom: "2025-01-01",
      dateTo: "2025-01-31",
      ...
      totalAmount: 160600,
      expenseCount: 2,
      notes: "Nabavka za nove zaposlene",
...
export function generateMockPolicies() {
  return [
    ...
    {
      id: "pol-3",
      name: "Oprema - odobrenje menadzera",
      category: "equipment",
      maxAmount: 500000,
      frequency: "quarterly",
      approvalThreshold: 0,
...
export function generateBudgetVsActual(
  budgets: Array<{
    name: string;
