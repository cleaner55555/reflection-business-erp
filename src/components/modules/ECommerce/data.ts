...
export const orderStatusConfig: Record<string, { label: string; color: string }> = {
  ...
  'potvrđena': { label: 'Potvrđena', color: 'bg-blue-100 text-blue-700' },
  u_pripremi: { label: 'U pripremi', color: 'bg-amber-100 text-amber-700' },
  poslata: { label: 'Poslata', color: 'bg-purple-100 text-purple-700' },
  u_isporuci: { label: 'U isporuci', color: 'bg-indigo-100 text-indigo-700' },
  isporučena: { label: 'Isporučena', color: 'bg-teal-100 text-teal-700' },
  završena: { label: 'Završena', color: 'bg-green-100 text-green-700' },
  otkazana: { label: 'Otkazana', color: 'bg-red-100 text-red-700' },
}
