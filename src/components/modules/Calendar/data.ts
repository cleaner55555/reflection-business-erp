export const COLORS: Record<string, string> = {
  ...
  green:
    "bg-emerald-100 border-emerald-200 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400",
  blue: "bg-blue-100 border-blue-200 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400",
  orange:
    "bg-amber-100 border-amber-200 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400",
  purple:
    "bg-purple-100 border-purple-200 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400",
...
export const formatDateShort = (dateStr: string) => {
  ...
  return isNaN(d.getTime())
    ? ""
    : d.toLocaleDateString("sr-RS", { day: "numeric", month: "short" });
};
