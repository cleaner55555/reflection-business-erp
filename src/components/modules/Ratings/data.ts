export const targetTypeConfig: Record<
  string,
...
export const surveyStatusConfig: Record<
  string,
...
export const ratingCriteria: RatingCriteria[] = [
  {
    id: "cr-1",
    name: "Kvalitet",
    description: "Kvalitet proizvoda ili usluge",
    weight: 30,
    scaleMax: 5,
    category: "quality",
  },
  {
    id: "cr-2",
    name: "Usluga",
    description: "Kvalitet usluživanja i podrške",
    weight: 25,
    scaleMax: 5,
    category: "support",
  },
  {
    id: "cr-3",
    name: "Cena",
    description: "Odnos cene i kvaliteta",
    weight: 20,
    scaleMax: 5,
    category: "pricing",
  },
  {
    id: "cr-4",
    name: "Vreme",
    description: "Vreme isporuke ili realizacije",
    weight: 15,
    scaleMax: 5,
    category: "delivery",
  },
  {
    id: "cr-5",
    name: "Komunikacija",
    description: "Komunikacija i odgovornost",
    weight: 10,
    scaleMax: 5,
...
export const mockRatings: Rating[] = [
  {
    ...
    time: 4,
    overall: 4.2,
    comment: "Odličan partner za razvoj softvera.",
    ratedBy: "Marko Petrović",
    ratedAt: "2025-01-18T10:00:00",
  },
  {
    id: "r-2",
    targetType: "vendor",
    targetId: "v-1",
    targetName: "TechSupply d.o.o.",
    category: "delivery",
    quality: 4,
    service: 3,
    price: 4,
    time: 5,
    overall: 4.0,
    comment: "Brza isporuka, dobri proizvodi.",
    ratedBy: "Jelena Stanković",
    ratedAt: "2025-01-17T14:00:00",
  },
  {
    id: "r-3",
    targetType: "employee",
    targetId: "e-1",
    targetName: "Marko Petrović",
    category: "expertise",
    quality: 5,
    service: 5,
    price: 0,
    time: 4,
    overall: 4.7,
    comment: "Izvanredna stručnost i predanost.",
    ratedBy: "Ana Nikolić",
    ratedAt: "2025-01-16T09:00:00",
  },
  {
    id: "r-4",
    targetType: "partner",
    targetId: "p-2",
    targetName: "XYZ Solutions",
    category: "communication",
    quality: 3,
    service: 4,
    price: 3,
    time: 3,
    overall: 3.3,
    comment: "Komunikacija može biti bolja.",
    ratedBy: "Petar Jovanović",
    ratedAt: "2025-01-15T11:00:00",
  },
  {
    id: "r-5",
    targetType: "vendor",
    targetId: "v-2",
    targetName: "OfficeMax",
    ...
    time: 4,
    overall: 4.3,
    comment: "Pouzdani dobavljač kancelarijskog materijala.",
    ratedBy: "Nikola Ilić",
    ratedAt: "2025-01-14T16:00:00",
  },
  {
    id: "r-6",
    targetType: "product",
    targetId: "pr-1",
    targetName: "ERP Modul - Knjigovodstvo",
    category: "quality",
    quality: 5,
    service: 4,
    price: 3,
    time: 0,
    overall: 4.2,
    comment: "SOLID modul za knjigovodstvo.",
    ratedBy: "Ana Nikolić",
    ratedAt: "2025-01-13T10:00:00",
  },
  {
    id: "r-7",
    targetType: "service",
    targetId: "s-1",
    targetName: "IT Podrška",
    ...
    time: 5,
    overall: 4.0,
    comment: "Brza reakcija na probleme.",
    ratedBy: "Ivan Đorđević",
    ratedAt: "2025-01-12T08:00:00",
  },
  {
    id: "r-8",
    targetType: "partner",
    targetId: "p-3",
    targetName: "DesignLab",
    category: "quality",
    quality: 4,
    service: 5,
    price: 2,
    time: 4,
    overall: 3.8,
    comment: "Odličan dizajn, ali skupo.",
    ratedBy: "Jelena Stanković",
    ratedAt: "2025-01-11T13:00:00",
  },
  {
    id: "r-9",
    targetType: "employee",
    targetId: "e-2",
    targetName: "Ana Nikolić",
    category: "leadership",
    quality: 5,
    service: 5,
    price: 0,
    time: 5,
    overall: 5.0,
    comment: "Izuzetan timski lead.",
    ratedBy: "Jelena Stanković",
    ratedAt: "2025-01-10T09:00:00",
  },
  {
    id: "r-10",
    targetType: "vendor",
    targetId: "v-3",
    targetName: "CloudHost",
    category: "reliability",
    quality: 4,
    service: 4,
    price: 4,
    time: 4,
    overall: 4.0,
    comment: "Stabilan hosting servis.",
    ratedBy: "Nikola Ilić",
    ratedAt: "2025-01-09T15:00:00",
  },
];
...
export const mockSurveys: Survey[] = [
  {
    id: "sv-1",
    name: "Zadovoljstvo partnera Q4 2024",
    description: "Quarterly partner satisfaction survey",
    status: "closed",
    questionCount: 12,
    responseCount: 34,
    avgRating: 4.1,
  ...
  {
    id: "sv-2",
    name: "Evaluacija dobavljača",
    description: "Godišnja evaluacija dobavljača",
    status: "active",
    questionCount: 8,
    responseCount: 15,
    avgRating: 3.8,
  ...
  {
    id: "sv-3",
    name: "Anketa o zadovoljstvu zaposlenih",
  ...
  },
  {
    id: "sv-4",
    name: "NPS - Klijenti",
    description: "Net Promoter Score za klijente",
    status: "closed",
    questionCount: 5,
    responseCount: 50,
    avgRating: 4.5,
